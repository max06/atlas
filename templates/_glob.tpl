...
{{- /*
glob — Custom glob pattern matching for helmfile templates.
Supports simple wildcards (*), wildcards in path segments, and recursive
matching (**). Returns a JSON array of matching file/directory paths.

Usage:
  {{- $matches := include "glob" "/path/to/dir/** /apps" | fromJson }}
*/ -}}
